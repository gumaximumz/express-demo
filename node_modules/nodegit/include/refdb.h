...
public:
  ...
  static Local<v8::Value> New(const git_refdb *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitRefdb(git_refdb *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitRefdb();
