...
public:
  ...
  static Local<v8::Value> New(const git_filter_list *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitFilterList(git_filter_list *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitFilterList();
