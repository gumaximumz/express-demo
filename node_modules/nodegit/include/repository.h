...
public:
  ...
  static Local<v8::Value> New(const git_repository *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
  ...
  struct FetchheadForeach_CallbackBaton : AsyncBaton {
    const char * refname;
    const char * remote_url;
    const git_oid * oid;
    unsigned int is_merge;
  ...
  static void MergeheadForeach_callback_async(uv_async_t* req, int status);
  static void MergeheadForeach_callback_promiseCompleted(bool isFulfilled, AsyncBaton *_baton, v8::Local<v8::Value> result);
  struct MergeheadForeach_CallbackBaton : AsyncBaton {
    const git_oid * oid;
    void * payload;
...
private:
  ...
  GitRepository(git_repository *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitRepository();
