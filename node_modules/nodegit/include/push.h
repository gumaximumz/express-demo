...
public:
  ...
  static Local<v8::Value> New(const git_push *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitPush(git_push *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitPush();
