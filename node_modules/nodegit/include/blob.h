...
public:
  ...
  static Local<v8::Value> New(const git_blob *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitBlob(git_blob *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitBlob();
