...
public:
  ...
  static Local<v8::Value> New(const git_indexer *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitIndexer(git_indexer *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitIndexer();
