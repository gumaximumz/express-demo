...
public:
  ...
  static Local<v8::Value> New(const git_oidarray *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitOidarray(git_oidarray *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitOidarray();
