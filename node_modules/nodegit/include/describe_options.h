...
public:
  ...
  static Local<v8::Value> New(const git_describe_options *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitDescribeOptions(git_describe_options *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitDescribeOptions();
