...
public:
  ...
  static Local<v8::Value> New(const git_cred_userpass_payload *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitCredUserpassPayload(git_cred_userpass_payload *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
