...
public:
  ...
  static Local<v8::Value> New(const git_diff_delta *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitDiffDelta(git_diff_delta *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitDiffDelta();
