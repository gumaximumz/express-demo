...
public:
  ...
  static Local<v8::Value> New(const git_diff_stats *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitDiffStats(git_diff_stats *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitDiffStats();
