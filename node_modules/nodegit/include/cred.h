...
public:
  ...
  static Local<v8::Value> New(const git_cred *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitCred(git_cred *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitCred();
