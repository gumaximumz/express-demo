...
public:
  ...
  static Local<v8::Value> New(const git_cred_default *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitCredDefault(git_cred_default *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitCredDefault();
