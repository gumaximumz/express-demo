...
public:
  ...
  static Local<v8::Value> New(const git_tag *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitTag(git_tag *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitTag();
