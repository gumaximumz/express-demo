...
public:
  ...
  static Local<v8::Value> New(const git_oid_shorten *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitOidShorten(git_oid_shorten *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitOidShorten();
