...
public:
  ...
  static Local<v8::Value> New(const git_cred_username *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitCredUsername(git_cred_username *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitCredUsername();
