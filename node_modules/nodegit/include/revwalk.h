...
public:
  ...
  static Local<v8::Value> New(const git_revwalk *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitRevwalk(git_revwalk *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitRevwalk();
