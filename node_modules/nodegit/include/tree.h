...
public:
  ...
  static Local<v8::Value> New(const git_tree *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitTree(git_tree *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitTree();
