...
public:
  ...
  static Local<v8::Value> New(const git_transaction *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitTransaction(git_transaction *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitTransaction();
