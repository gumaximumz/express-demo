...
public:
  ...
  static Local<v8::Value> New(const git_cert *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitCert(git_cert *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitCert();
