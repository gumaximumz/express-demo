...
public:
  ...
  static Local<v8::Value> New(const git_error *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitError(git_error *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitError();
