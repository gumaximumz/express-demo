...
public:
  ...
  static Local<v8::Value> New(const git_reflog_entry *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitReflogEntry(git_reflog_entry *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitReflogEntry();
