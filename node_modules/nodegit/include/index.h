...
public:
  ...
  static Local<v8::Value> New(const git_index *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
  ...
  struct AddAll_CallbackBaton : AsyncBaton {
    const char * path;
    const char * matched_pathspec;
    void * payload;
  ...
  struct RemoveAll_CallbackBaton : AsyncBaton {
    const char * path;
    const char * matched_pathspec;
    void * payload;
  ...
  struct UpdateAll_CallbackBaton : AsyncBaton {
    const char * path;
    const char * matched_pathspec;
    void * payload;
...
private:
  ...
  GitIndex(git_index *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitIndex();
