...
public:
  ...
  static Local<v8::Value> New(const git_commit *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitCommit(git_commit *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitCommit();
