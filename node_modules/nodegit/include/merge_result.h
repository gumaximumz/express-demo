...
public:
  ...
  static Local<v8::Value> New(const git_merge_result *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitMergeResult(git_merge_result *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitMergeResult();
