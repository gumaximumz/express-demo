...
public:
  ...
  static Local<v8::Value> New(const git_time *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitTime(git_time *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitTime();
