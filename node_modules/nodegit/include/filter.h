...
public:
  ...
  static Local<v8::Value> New(const git_filter *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitFilter(git_filter *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitFilter();
