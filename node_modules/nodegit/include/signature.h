...
public:
  ...
  static Local<v8::Value> New(const git_signature *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitSignature(git_signature *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitSignature();
