...
public:
  ...
  static Local<v8::Value> New(const git_oid *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitOid(git_oid *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitOid();
