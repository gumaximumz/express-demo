...
public:
  ...
  static Local<v8::Value> New(const git_diff_binary *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitDiffBinary(git_diff_binary *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitDiffBinary();
