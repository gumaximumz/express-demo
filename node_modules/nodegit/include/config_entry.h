...
public:
  ...
  static Local<v8::Value> New(const git_config_entry *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitConfigEntry(git_config_entry *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitConfigEntry();
