...
public:
  ...
  static Local<v8::Value> New(const git_pathspec_match_list *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitPathspecMatchList(git_pathspec_match_list *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
