...
public:
  ...
  static Local<v8::Value> New(const git_diff *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitDiff(git_diff *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitDiff();
