...
public:
  ...
  static Local<v8::Value> New(const git_writestream *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitWritestream(git_writestream *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitWritestream();
