...
public:
  ...
  static Local<v8::Value> New(const git_push_update *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitPushUpdate(git_push_update *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitPushUpdate();
