...
public:
  ...
  static Local<v8::Value> New(const git_index_time *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitIndexTime(git_index_time *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitIndexTime();
