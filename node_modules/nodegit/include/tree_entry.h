...
public:
  ...
  static Local<v8::Value> New(const git_tree_entry *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitTreeEntry(git_tree_entry *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitTreeEntry();
