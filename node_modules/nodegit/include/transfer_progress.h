...
public:
  ...
  static Local<v8::Value> New(const git_transfer_progress *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitTransferProgress(git_transfer_progress *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitTransferProgress();
