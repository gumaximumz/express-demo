...
public:
  ...
  static Local<v8::Value> New(const git_cert_x509 *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitCertX509(git_cert_x509 *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitCertX509();
