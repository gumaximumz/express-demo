...
public:
  ...
  static Local<v8::Value> New(const git_patch *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitPatch(git_patch *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitPatch();
