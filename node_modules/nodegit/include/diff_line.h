...
public:
  ...
  static Local<v8::Value> New(const git_diff_line *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitDiffLine(git_diff_line *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitDiffLine();
