...
public:
  ...
  static Local<v8::Value> New(const git_diff_binary_file *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitDiffBinaryFile(git_diff_binary_file *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitDiffBinaryFile();
