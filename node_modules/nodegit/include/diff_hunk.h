...
public:
  ...
  static Local<v8::Value> New(const git_diff_hunk *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitDiffHunk(git_diff_hunk *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitDiffHunk();
