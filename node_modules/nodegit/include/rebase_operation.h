...
public:
  ...
  static Local<v8::Value> New(const git_rebase_operation *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  bool selfFreeing;
...
private:
  ...
  GitRebaseOperation(git_rebase_operation *raw, bool selfFreeing, Local<v8::Object> owner = Local<v8::Object>());
  ~GitRebaseOperation();
