...
GitSubmodule::GitSubmodule(git_submodule *raw, bool selfFreeing, Local<v8::Object> owner)
{
  if (!owner.IsEmpty()) {
...
NAN_METHOD(GitSubmodule::JSNewFunction)
{
  ...
  GitSubmodule* object = new GitSubmodule(static_cast<git_submodule *>(
...
Local<v8::Value> GitSubmodule::New(const git_submodule *raw, bool selfFreeing, Local<v8::Object> owner)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), owner };
  return scope.Escape(
           Nan::NewInstance(
             Nan::New(GitSubmodule::constructor_template),
             owner.IsEmpty() ? 2 : 3, // passing an empty handle as part of the arguments causes a crash
             argv
           ).ToLocalChecked());
}

NAN_METHOD(GitSubmodule::GetSelfFreeingInstanceCount)
{
  info.GetReturnValue().Set(SelfFreeingInstanceCount);
}

NAN_METHOD(GitSubmodule::GetNonSelfFreeingConstructedCount)
{
...
int GitSubmodule::SelfFreeingInstanceCount;
int GitSubmodule::NonSelfFreeingConstructedCount;
