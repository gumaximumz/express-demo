...
GitBlame::GitBlame(git_blame *raw, bool selfFreeing, Local<v8::Object> owner)
{
  if (!owner.IsEmpty()) {
...
NAN_METHOD(GitBlame::JSNewFunction)
{
  ...
  GitBlame* object = new GitBlame(static_cast<git_blame *>(
...
Local<v8::Value> GitBlame::New(const git_blame *raw, bool selfFreeing, Local<v8::Object> owner)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), owner };
  return scope.Escape(
           Nan::NewInstance(
             Nan::New(GitBlame::constructor_template),
             owner.IsEmpty() ? 2 : 3, // passing an empty handle as part of the arguments causes a crash
             argv
           ).ToLocalChecked());
}

NAN_METHOD(GitBlame::GetSelfFreeingInstanceCount)
{
  info.GetReturnValue().Set(SelfFreeingInstanceCount);
}

NAN_METHOD(GitBlame::GetNonSelfFreeingConstructedCount)
{
...
int GitBlame::SelfFreeingInstanceCount;
int GitBlame::NonSelfFreeingConstructedCount;
