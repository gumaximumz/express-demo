...
GitOdbObject::GitOdbObject(git_odb_object *raw, bool selfFreeing, Local<v8::Object> owner)
{
  if (!owner.IsEmpty()) {
...
NAN_METHOD(GitOdbObject::JSNewFunction)
{
  ...
  GitOdbObject* object = new GitOdbObject(static_cast<git_odb_object *>(
...
Local<v8::Value> GitOdbObject::New(const git_odb_object *raw, bool selfFreeing, Local<v8::Object> owner)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), owner };
  return scope.Escape(
           Nan::NewInstance(
             Nan::New(GitOdbObject::constructor_template),
             owner.IsEmpty() ? 2 : 3, // passing an empty handle as part of the arguments causes a crash
             argv
           ).ToLocalChecked());
}

NAN_METHOD(GitOdbObject::GetSelfFreeingInstanceCount)
{
  info.GetReturnValue().Set(SelfFreeingInstanceCount);
}

NAN_METHOD(GitOdbObject::GetNonSelfFreeingConstructedCount)
{
...
int GitOdbObject::SelfFreeingInstanceCount;
int GitOdbObject::NonSelfFreeingConstructedCount;
