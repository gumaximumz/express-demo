...
GitDescribeOptions::GitDescribeOptions(git_describe_options *raw, bool selfFreeing, Local<v8::Object> owner)
{
  if (!owner.IsEmpty()) {
...
NAN_METHOD(GitDescribeOptions::JSNewFunction)
{
  ...
  GitDescribeOptions* object = new GitDescribeOptions(static_cast<git_describe_options *>(
...
Local<v8::Value> GitDescribeOptions::New(const git_describe_options *raw, bool selfFreeing, Local<v8::Object> owner)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), owner };
  return scope.Escape(
           Nan::NewInstance(
             Nan::New(GitDescribeOptions::constructor_template),
             owner.IsEmpty() ? 2 : 3, // passing an empty handle as part of the arguments causes a crash
             argv
           ).ToLocalChecked());
}

NAN_METHOD(GitDescribeOptions::GetSelfFreeingInstanceCount)
{
  info.GetReturnValue().Set(SelfFreeingInstanceCount);
}

NAN_METHOD(GitDescribeOptions::GetNonSelfFreeingConstructedCount)
{
...
int GitDescribeOptions::SelfFreeingInstanceCount;
int GitDescribeOptions::NonSelfFreeingConstructedCount;
