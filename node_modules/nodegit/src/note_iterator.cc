...
GitNoteIterator::GitNoteIterator(git_note_iterator *raw, bool selfFreeing, Local<v8::Object> owner)
{
  if (!owner.IsEmpty()) {
...
NAN_METHOD(GitNoteIterator::JSNewFunction)
{
  ...
  GitNoteIterator* object = new GitNoteIterator(static_cast<git_note_iterator *>(
...
Local<v8::Value> GitNoteIterator::New(const git_note_iterator *raw, bool selfFreeing, Local<v8::Object> owner)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), owner };
  return scope.Escape(
           Nan::NewInstance(
             Nan::New(GitNoteIterator::constructor_template),
             owner.IsEmpty() ? 2 : 3, // passing an empty handle as part of the arguments causes a crash
             argv
           ).ToLocalChecked());
}

NAN_METHOD(GitNoteIterator::GetSelfFreeingInstanceCount)
{
  info.GetReturnValue().Set(SelfFreeingInstanceCount);
}

NAN_METHOD(GitNoteIterator::GetNonSelfFreeingConstructedCount)
{
...
int GitNoteIterator::SelfFreeingInstanceCount;
int GitNoteIterator::NonSelfFreeingConstructedCount;
