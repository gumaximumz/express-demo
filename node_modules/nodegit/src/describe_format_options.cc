...
GitDescribeFormatOptions::GitDescribeFormatOptions(git_describe_format_options *raw, bool selfFreeing, Local<v8::Object> owner)
{
  if (!owner.IsEmpty()) {
...
NAN_METHOD(GitDescribeFormatOptions::JSNewFunction)
{
  ...
  GitDescribeFormatOptions* object = new GitDescribeFormatOptions(static_cast<git_describe_format_options *>(
...
Local<v8::Value> GitDescribeFormatOptions::New(const git_describe_format_options *raw, bool selfFreeing, Local<v8::Object> owner)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), owner };
  return scope.Escape(
           Nan::NewInstance(
             Nan::New(GitDescribeFormatOptions::constructor_template),
             owner.IsEmpty() ? 2 : 3, // passing an empty handle as part of the arguments causes a crash
             argv
           ).ToLocalChecked());
}

NAN_METHOD(GitDescribeFormatOptions::GetSelfFreeingInstanceCount)
{
  info.GetReturnValue().Set(SelfFreeingInstanceCount);
}

NAN_METHOD(GitDescribeFormatOptions::GetNonSelfFreeingConstructedCount)
{
...
int GitDescribeFormatOptions::SelfFreeingInstanceCount;
int GitDescribeFormatOptions::NonSelfFreeingConstructedCount;
