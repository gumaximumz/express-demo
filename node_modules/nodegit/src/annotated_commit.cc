...
GitAnnotatedCommit::GitAnnotatedCommit(git_annotated_commit *raw, bool selfFreeing, Local<v8::Object> owner)
{
  if (!owner.IsEmpty()) {
...
NAN_METHOD(GitAnnotatedCommit::JSNewFunction)
{
  ...
  GitAnnotatedCommit* object = new GitAnnotatedCommit(static_cast<git_annotated_commit *>(
...
Local<v8::Value> GitAnnotatedCommit::New(const git_annotated_commit *raw, bool selfFreeing, Local<v8::Object> owner)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), owner };
  return scope.Escape(
           Nan::NewInstance(
             Nan::New(GitAnnotatedCommit::constructor_template),
             owner.IsEmpty() ? 2 : 3, // passing an empty handle as part of the arguments causes a crash
             argv
           ).ToLocalChecked());
}

NAN_METHOD(GitAnnotatedCommit::GetSelfFreeingInstanceCount)
{
  info.GetReturnValue().Set(SelfFreeingInstanceCount);
}

NAN_METHOD(GitAnnotatedCommit::GetNonSelfFreeingConstructedCount)
{
...
int GitAnnotatedCommit::SelfFreeingInstanceCount;
int GitAnnotatedCommit::NonSelfFreeingConstructedCount;
