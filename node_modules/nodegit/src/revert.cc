...
void GitRevert::RevertWorker::HandleOKCallback()
{
  if (baton->error_code == GIT_OK) {
    ...
    if (baton->error) {
      ...
      if (!callbackFired) {
        Local<v8::Object> err = Nan::Error("Method revert has thrown an error.")->ToObject();
...
int GitRevert::SelfFreeingInstanceCount;
int GitRevert::NonSelfFreeingConstructedCount;
