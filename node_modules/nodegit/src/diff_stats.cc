...
GitDiffStats::GitDiffStats(git_diff_stats *raw, bool selfFreeing, Local<v8::Object> owner)
{
  if (!owner.IsEmpty()) {
...
void GitDiffStats::InitializeComponent(Local<v8::Object> target)
{
...
NAN_METHOD(GitDiffStats::JSNewFunction)
{
  ...
  if (info.Length() == 0 || !info[0]->IsExternal()) {
    return Nan::ThrowError("A new GitDiffStats cannot be instantiated.");
  }

  GitDiffStats* object = new GitDiffStats(static_cast<git_diff_stats *>(
...
Local<v8::Value> GitDiffStats::New(const git_diff_stats *raw, bool selfFreeing, Local<v8::Object> owner)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), owner };
  return scope.Escape(
           Nan::NewInstance(
             Nan::New(GitDiffStats::constructor_template),
             owner.IsEmpty() ? 2 : 3, // passing an empty handle as part of the arguments causes a crash
             argv
           ).ToLocalChecked());
}

NAN_METHOD(GitDiffStats::GetSelfFreeingInstanceCount)
{
  info.GetReturnValue().Set(SelfFreeingInstanceCount);
}

NAN_METHOD(GitDiffStats::GetNonSelfFreeingConstructedCount)
{
...
Nan::Persistent<Function> GitDiffStats::constructor_template;

int GitDiffStats::SelfFreeingInstanceCount;
int GitDiffStats::NonSelfFreeingConstructedCount;
