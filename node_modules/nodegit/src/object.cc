...
GitObject::GitObject(git_object *raw, bool selfFreeing, Local<v8::Object> owner)
{
  if (!owner.IsEmpty()) {
...
void GitObject::InitializeComponent(Local<v8::Object> target)
{
...
NAN_METHOD(GitObject::JSNewFunction)
{
  ...
  if (info.Length() == 0 || !info[0]->IsExternal()) {
    return Nan::ThrowError("A new GitObject cannot be instantiated.");
  }

  GitObject* object = new GitObject(static_cast<git_object *>(
...
Local<v8::Value> GitObject::New(const git_object *raw, bool selfFreeing, Local<v8::Object> owner)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), owner };
  return scope.Escape(
           Nan::NewInstance(
             Nan::New(GitObject::constructor_template),
             owner.IsEmpty() ? 2 : 3, // passing an empty handle as part of the arguments causes a crash
             argv
           ).ToLocalChecked());
}

NAN_METHOD(GitObject::GetSelfFreeingInstanceCount)
{
  info.GetReturnValue().Set(SelfFreeingInstanceCount);
}

NAN_METHOD(GitObject::GetNonSelfFreeingConstructedCount)
{
...
// start convert_to_v8 block
    ...
    if (baton->dest != NULL) {
      ...
      to = GitObject::New(baton->dest, false  );
    } else {
      to = Nan::Null();
    }
...
NAN_METHOD(GitObject::Free)
{
  ...
  if (Nan::ObjectWrap::Unwrap<GitObject>(info.This())->GetValue() != NULL) {

    giterr_clear();

    {
      LockMaster lockMaster(/*asyncAction: */false        ,    Nan::ObjectWrap::Unwrap<GitObject>(info.This())->GetValue()
                           );
      ...
      Nan::ObjectWrap::Unwrap<GitObject>(info.This())->ClearValue();
    }
...
// start convert_to_v8 block
    ...
    if (baton->object != NULL) {
      ...
      to = GitObject::New(baton->object, false  );
    } else {
      to = Nan::Null();
    }
...
// start convert_from_v8 block
  git_otype from_type;
  from_type = (git_otype)  (int) info[1]->ToNumber()->Value();
// end convert_from_v8 block
  baton->type = from_type;
  ...
  if (!info[1]->IsUndefined() && !info[1]->IsNull())
    worker->SaveToPersistent("type", info[1]->ToObject());
...
void GitObject::LookupBypathWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(/*asyncAction: */true        ,baton->treeish
                                           ,baton->path
                         );
...
// end convert_to_v8 block
    ...
    if (baton->error) {
      ...
      if (!callbackFired) {
        Local<v8::Object> err = Nan::Error("Method lookupByPath has thrown an error.")->ToObject();
        err->Set(Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
        Local<v8::Value> argv[1] = {
          err
        };
...
// start convert_from_v8 block
  git_otype from_type;
  from_type = (git_otype)  (int) info[3]->ToNumber()->Value();
// end convert_from_v8 block
  baton->type = from_type;
  ...
  if (!info[3]->IsUndefined() && !info[3]->IsNull())
    worker->SaveToPersistent("type", info[3]->ToObject());
...
// start convert_from_v8 block
  ...
  from_target_type = (git_otype)  (int) info[0]->ToNumber()->Value();
// end convert_from_v8 block
  ...
  if (!info[0]->IsUndefined() && !info[0]->IsNull())
    worker->SaveToPersistent("target_type", info[0]->ToObject());
...
void GitObject::PeelWorker::Execute()
{
  ...
  {
    LockMaster lockMaster(/*asyncAction: */true        ,baton->object
                         );
...
// start convert_to_v8 block
    ...
    if (baton->peeled != NULL) {
      ...
      to = GitObject::New(baton->peeled, false  );
    } else {
      to = Nan::Null();
    }
...
// end convert_to_v8 block
    ...
    if (baton->error) {
      ...
      if (!callbackFired) {
        Local<v8::Object> err = Nan::Error("Method shortId has thrown an error.")->ToObject();
        err->Set(Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
        Local<v8::Value> argv[1] = {
          err
        };
...
Nan::Persistent<Function> GitObject::constructor_template;

int GitObject::SelfFreeingInstanceCount;
int GitObject::NonSelfFreeingConstructedCount;
