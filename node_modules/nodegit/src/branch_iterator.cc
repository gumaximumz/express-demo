...
GitBranchIterator::GitBranchIterator(git_branch_iterator *raw, bool selfFreeing, Local<v8::Object> owner)
{
  if (!owner.IsEmpty()) {
...
NAN_METHOD(GitBranchIterator::JSNewFunction)
{
  ...
  GitBranchIterator* object = new GitBranchIterator(static_cast<git_branch_iterator *>(
...
Local<v8::Value> GitBranchIterator::New(const git_branch_iterator *raw, bool selfFreeing, Local<v8::Object> owner)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), owner };
  return scope.Escape(
           Nan::NewInstance(
             Nan::New(GitBranchIterator::constructor_template),
             owner.IsEmpty() ? 2 : 3, // passing an empty handle as part of the arguments causes a crash
             argv
           ).ToLocalChecked());
}

NAN_METHOD(GitBranchIterator::GetSelfFreeingInstanceCount)
{
  info.GetReturnValue().Set(SelfFreeingInstanceCount);
}

NAN_METHOD(GitBranchIterator::GetNonSelfFreeingConstructedCount)
{
...
int GitBranchIterator::SelfFreeingInstanceCount;
int GitBranchIterator::NonSelfFreeingConstructedCount;
