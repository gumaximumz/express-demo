...
GitPackbuilder::GitPackbuilder(git_packbuilder *raw, bool selfFreeing, Local<v8::Object> owner)
{
  if (!owner.IsEmpty()) {
...
NAN_METHOD(GitPackbuilder::JSNewFunction)
{
  ...
  GitPackbuilder* object = new GitPackbuilder(static_cast<git_packbuilder *>(
...
Local<v8::Value> GitPackbuilder::New(const git_packbuilder *raw, bool selfFreeing, Local<v8::Object> owner)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), owner };
  return scope.Escape(
           Nan::NewInstance(
             Nan::New(GitPackbuilder::constructor_template),
             owner.IsEmpty() ? 2 : 3, // passing an empty handle as part of the arguments causes a crash
             argv
           ).ToLocalChecked());
}

NAN_METHOD(GitPackbuilder::GetSelfFreeingInstanceCount)
{
  info.GetReturnValue().Set(SelfFreeingInstanceCount);
}

NAN_METHOD(GitPackbuilder::GetNonSelfFreeingConstructedCount)
{
...
int GitPackbuilder::SelfFreeingInstanceCount;
int GitPackbuilder::NonSelfFreeingConstructedCount;
