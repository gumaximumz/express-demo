...
GitHashsig::GitHashsig(git_hashsig *raw, bool selfFreeing, Local<v8::Object> owner)
{
  if (!owner.IsEmpty()) {
...
NAN_METHOD(GitHashsig::JSNewFunction)
{
  ...
  GitHashsig* object = new GitHashsig(static_cast<git_hashsig *>(
...
Local<v8::Value> GitHashsig::New(const git_hashsig *raw, bool selfFreeing, Local<v8::Object> owner)
{
  Nan::EscapableHandleScope scope;
  Local<v8::Value> argv[3] = { Nan::New<External>((void *)raw), Nan::New(selfFreeing), owner };
  return scope.Escape(
           Nan::NewInstance(
             Nan::New(GitHashsig::constructor_template),
             owner.IsEmpty() ? 2 : 3, // passing an empty handle as part of the arguments causes a crash
             argv
           ).ToLocalChecked());
}

NAN_METHOD(GitHashsig::GetSelfFreeingInstanceCount)
{
  info.GetReturnValue().Set(SelfFreeingInstanceCount);
}

NAN_METHOD(GitHashsig::GetNonSelfFreeingConstructedCount)
{
...
int GitHashsig::SelfFreeingInstanceCount;
int GitHashsig::NonSelfFreeingConstructedCount;
